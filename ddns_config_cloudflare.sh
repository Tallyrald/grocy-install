...
sed -i "s/read_token_placeholder/$readtoken/g" /var/www/html/data/cloudflare-update-record_config.yaml
sed -i "s/edit_token_placeholder/$edittoken/g" /var/www/html/data/cloudflare-update-record_config.yaml
